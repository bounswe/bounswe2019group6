...
import cmpe451.group6.authorization.service.CustomizedUserDetails;
...
public class JwtTokenProvider {
  ...
  private final CustomizedUserDetails customizedUserDetails;

  private final HazelcastService hazelcastService;

  public JwtTokenProvider(CustomizedUserDetails customizedUserDetails, HazelcastService hazelcastService) {
    this.customizedUserDetails = customizedUserDetails;
  ...
  public Authentication getAuthentication(String token) {
    UserDetails userDetails = customizedUserDetails.loadUserByUsername(getUsername(token));
