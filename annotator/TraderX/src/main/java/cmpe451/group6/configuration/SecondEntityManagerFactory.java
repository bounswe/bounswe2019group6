...
@EnableJpaRepositories(
        ...
        basePackages = "cmpe451.group6.authorization"
)
...
public class SecondEntityManagerFactory {
    ...
    public LocalContainerEntityManagerFactoryBean ds2EntityManagerFactory(
            EntityManagerFactoryBuilder builder, @Qualifier("dataSourceMainDb") DataSource dataSource) {
