...
public class SignupController {
        ...
        public String confirm(@ApiParam("ConfirmationToken") @RequestParam String token) {
            return signupService.confirmUser(token);
        }
        ...
        public String signup(@ApiParam("Signup User") @RequestBody UserDataDTO user) {
            return signupService.signup(modelMapper.map(user, User.class));
        }
