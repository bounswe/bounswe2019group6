    ...
    <div class="cols">
        <div class="col" ontouchstart="this.classList.toggle('hover');" v-for="portfolio in this.cardData"  v-bind:key="portfolio">
          <div class="container" @click="goToPortfolio(portfolio.portfolioName)">
            <div class="front" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvLfc6cXyyahw-SHzgfii9PsDjPWu34pwy2_JFw31cd9wxwUhW7Q&s)">
              <div class="inner">
                <p>{{ portfolio.portfolioName }}</p>
                <!-- <span>Lorem ipsum</span> -->
              </div>
            </div>
            <div class="back" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTm_PlBHiD2fhWroxNfx3XC0gPfPDqkOlQJA3FfZGnQlV0WzEwh&s)">
              <div class="inner">
